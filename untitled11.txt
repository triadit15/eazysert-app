...
def find_sa_id(text):
    """Extracts first 13-digit SA ID from text."""
    match = re.search(r'\b\d{13}\b', text)
    return match.group() if match else None

def add_certification_stamp(image_path):
    """Adds big bold certification stamp to the center of the document."""
    ...
    text_width, text_height = draw.multiline_textsize(stamp_text, font=font, spacing=20)
    ...
    draw.multiline_text((x, y), stamp_text, fill="red", font=font, spacing=20, align="center")
