...
def index():
    if request.method == 'POST':
        ...
        if file:
            ...
            try:
                extracted_text = pytesseract.image_to_string(Image.open(output_path))
            except Exception as e:
            ...
            return render_template("verify_result.html", result=result, image_path=output_filename)
